...
const handleDropdownToggle = () => {
  ...
  return (
      <div className='topbar w-full  flex items-center justify-between  md:py-2.5 px-4 bg-primary'>
          <Link to="/" className='flex gap-2 items-center'>
              ...
              <span className='text-xl md:text-2xl text-[#065ad8] font-semibold'>LookUp</span>
          ...
          <div className='flex gap-4 items-center text-ascent-1 text-md md:text-xl'>
              ...
              <div><BsFillChatDotsFill></BsFillChatDotsFill></div>
           <div className="relative">
  <button
    onClick={() => handleDropdownToggle()} // Add a function to toggle the dropdown
  ...
  {isDropdownOpen && (
    <div className="absolute mt-2 py-2    rounded-md">
      {/* Dropdown content */}
      <button onClick={() => dispatch(Logout())} className="block w-full px-5 border rounded-full text-sm">
        Logout
      </button>
